    ...
    return (
        <div class="max-w-sm rounded-lg shadow dark:bg-secondary  bg-primary_light dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center font-primary text-white bg-tertiary rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-tertiary dark:hover:bg-blue-700 dark:focus:ring-blue-800">
