...
export function ProfileCard({ data }) {
  return (
    <Card className="md:w-96 md:min-w-[24rem] mx-auto dark:bg-secondary bg-primary_light  ">
      ...
      <CardBody className="text-center">
        <Typography
          variant="h4"
          className="text-contrast font-medium font-primary mb-2 "
        >
          {data.name}
        </Typography>
        <Typography
          variant="h5"
          className="font-medium font-primary dark:text-tertiary text-secondary_light  "
          textGradient
        >
          {data.title}
        </Typography>
